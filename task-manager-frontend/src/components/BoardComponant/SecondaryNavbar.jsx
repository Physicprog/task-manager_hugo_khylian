...
export default function SecondaryNavbar({ isTemplateMode = false, boardName }) {
    ...
    return (
        <>
            <div className="fixed top-[60px] left-0 right-0 z-[1000] h-[35px] bg-navbar px-4 flex items-center border-b border-text">
                <div className="flex justify-between gap-2 items-center w-full">
                    ...
                    <div className="flex items-center gap-4">
                        <img src={isFavorite ? fav : nofav} alt="favorite" className="h-5 w-[1.3rem] cursor-pointer hover:opacity-70 transition" onClick={toggleFavorite} />
